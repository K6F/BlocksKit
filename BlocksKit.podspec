Pod::Spec.new do |s|
  ...
  s.source                = { :https://github.com/K-Be/BlocksKit.git', :tag => "v#{s.version}" }
  s.requires_arc          = true
  ...
  s.subspec 'Core' do |ss|
    ss.source_files = 'BlocksKit/BlocksKit.h', "BlocksKit/BKDefines.h", 'BlocksKit/Core/*.{h,m}, BlocksKit/Queue/*.{h,m}'
  end
